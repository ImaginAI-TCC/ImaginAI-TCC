...
class VAE_Encoder(nn.Sequential):
    ...
    def forward(self, x, noise):
        ...
        # escaalonado pela contante pega em:https://github.com/CompVis/stable-diffusion/blob/21f890f9da3cfbeaba8e2ac3c425ee9e998d5229/configs/stable-diffusion/v1-inference.yaml#L17C1-L17C1
        x *= 0.18215
